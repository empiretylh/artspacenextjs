...
import { useGetGalleriesInfinite } from "@/features/service/artspace/get-galleries";
import ArtistsPageView from "@/features/artist/components/artists-page-view";

const GalleriesPageContainer = () => {
   // -----------------------------------------
   // State
   // -----------------------------------------
...
export default GalleriesPageContainer;
