...
export const getLikedArtworksByCurrentUserQueryOptions = (
   options: {
      filters?: ColumnFiltersState;
      sorts?: SortingState;
      page?: number;
   ...
   return queryOptions({
      queryKey: queryKeys.artwork.liked.me({
         filters,
         sorts,
         search,
         page,
...
type UseArtworksOptions = {
   ...
   search?: string;
   filters?: ColumnFiltersState;
   queryConfig?: QueryConfig<typeof getLikedArtworksByCurrentUserQueryOptions>;
};

export const useGetLikedArtworksByCurrentUser = ({
   queryConfig,
   filters,
   sorts,
   search,
   ...
   return useQuery({
      ...getLikedArtworksByCurrentUserQueryOptions({
         filters,
         sorts,
         page,
         limit,
...
export const getLikedArtworksByCurrentUserQueryInfiniteOptions = (
   options: {
      filters?: ColumnFiltersState;
      sorts?: SortingState;
      page?: number;
...
export const useGetLikedArtworksByCurrentUserInfinite = ({
   filters,
   sorts,
   search,
   limit = 10,
